...
export default function AddCustomerGroup() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success('Đã tạo nhóm khách hàng thành công');
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold">Tạo nhóm khách hàng mới</h1>
        </div>
        <div className="flex gap-2">
          ...
          <Button onClick={handleSubmit}>
            <Check className="mr-2 h-4 w-4" /> Lưu nhóm
          </Button>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Thiết lập thông tin cơ bản của nhóm khách hàng
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Thêm khách hàng vào nhóm</CardTitle>
          <CardDescription>
            Chọn phương thức thêm khách hàng vào nhóm
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="manual" onValueChange={setSelectionMethod}>
